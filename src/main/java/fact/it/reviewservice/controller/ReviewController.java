...
public class ReviewController {
    ...
    Review getReviewByUserIdAndProductId(@PathVariable String userId, @PathVariable String productId){
    ...
    public ResponseEntity deleteReview(@PathVariable String userId, @PathVariable String productId){
